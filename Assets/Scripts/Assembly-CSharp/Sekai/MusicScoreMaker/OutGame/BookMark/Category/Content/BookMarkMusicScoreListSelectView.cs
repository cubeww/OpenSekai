...
{
	public sealed class BookMarkMusicScoreListSelectView : ContentViewBase<BookMarkMusicScoreListSelectViewData>
	{
		...
		private struct _003CFadeInListAsync_003Ed__12 : IAsyncStateMachine
		{
			...
			public BookMarkMusicScoreListSelectView _003C_003E4__this;
		...
		[SerializeField]
		private CustomTextMesh _bookmarkCountText;

		[SerializeField]
		private CanvasGroup _listContentCanvasGroup;

		[AsyncStateMachine(typeof(_003CSetupAsync_003Ed__6))]
		public UniTask SetupAsync(Action<int> onSelectMusicScore, Action<int> onSelectFilter, Action onClickFilterButton, Action<SortOrderBy> onChangeSortOrder)
		{
			throw null;
		}
		...
		public BookMarkMusicScoreListSelectView()
		{
			throw null;
		}
	}
