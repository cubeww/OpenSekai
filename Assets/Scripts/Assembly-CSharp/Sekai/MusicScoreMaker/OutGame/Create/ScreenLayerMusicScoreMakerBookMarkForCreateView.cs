...
{
	public class ScreenLayerMusicScoreMakerBookMarkForCreateView : MonoBehaviour, IDisposable
	{
		...
		private struct _003CHideHeaderAsync_003Ed__10 : IAsyncStateMachine
		{
			...
			public ScreenLayerMusicScoreMakerBookMarkForCreateView _003C_003E4__this;
		...
		[SerializeField]
		private BookMarkForCreateCategory _category;
		...
		public BookMarkForCreateCategory Category
		{
			get
			{
				throw null;
		...
		public ScreenLayerMusicScoreMakerBookMarkForCreateView()
		{
			throw null;
		}
	}
